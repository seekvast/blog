...
interface NotificationDesktopMenuProps {
  activeType: NotificationTabType;
  onTypeChange: (type: NotificationTabType) => void;
}

export function NotificationDesktopMenu({
  activeType,
  onTypeChange,
}: NotificationDesktopMenuProps) {
...
export function NotificationMobileMenu({
  activeType,
  onTypeChange,
}: NotificationMobileMenuProps) {
  return (
