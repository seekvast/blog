...
import { MessageSquare, Heart, Share2, MoreHorizontal, ChevronDown } from "lucide-react"
...
const SAMPLE_POSTS = [
  {
    ...
    title: "那些喜欢小女生的根本人渣==",
    content: "那些喜欢小女生的根本人渣==,rt那些喜欢小女生的根本人渣==,rt那些喜欢小女生的根本人渣==,rt",
      ...
      <div className="bg-white">
        <div className="mx-auto w-[808px] px-8">
          ...
          <div className="flex items-center space-x-4 py-3 text-sm">
            <Button variant="default" size="sm" className="rounded-full">全部</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">综合</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">討論</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">漫畫</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">小說</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">繪畫</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">開期</Button>
            <Button variant="ghost" size="sm" className="rounded-full text-muted-foreground">八卦</Button>
          </div>
        </div>
      </div>
